...
## Summary
- 1089 nodes · 1912 edges · 127 communities (79 shown, 48 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 11 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5564a6f0`
...
- `UsersTable()` --calls--> `getUsersColumns()`  [EXTRACTED]
  frontend/features/admin/components/UsersTable.tsx → frontend/features/admin/components/UsersColumns.tsx
...
Cohesion: 0.08
Nodes (41): AdminCampaignsPage(), CitizenLayout(), CareerSection(), OurStory(), priorities, campaignsColumns, CampaignsTable(), CitizenDashboard() (+33 more)

### Community 3 - "Admin Dashboard & Tables"
Cohesion: 0.27
Nodes (11): Toaster(), Spinner(), Table(), TableBody(), TableCaption(), TableCell(), TableFooter(), TableHead() (+3 more)
...
Cohesion: 0.06
Nodes (34): dependencies, class-variance-authority, clsx, formik, framer-motion, lucide-react, next, next-themes (+26 more)

### Community 22 - "Community 22"
Cohesion: 0.1
Nodes (19): 17. Abuse & Moderation Module, 18. Notification System, 24. Security Requirements, 26. SEO Requirements, 28. Scalability Requirements, 30. Future Scope, 3. User Roles, 5. Core Functional Modules (+11 more)
...
Cohesion: 0.22
Nodes (4): BlogsPage(), EventsPage(), PageHero(), PageHeroProps
...
Cohesion: 0.06
Nodes (60): AwarenessFeature(), AwarenessPage(), metadata, AwarenessForm(), AwarenessFormProps, validationSchema, AwarenessList(), mockActivities (+52 more)
...
Cohesion: 0.16
Nodes (3): RegisterForm(), JoinUsPage(), programs
...
## Knowledge Gaps
- **383 isolated node(s):** `config`, `name`, `version`, `private`, `dev` (+378 more)
...
- **Why does `cn()` connect `Community 86` to `Forms & Citizen Dashboard`, `Admin Dashboard & Tables`, `Community 100`, `Layout & Navigation Utilities`, `Package Dependencies & Scripts`, `Root Layout & Fonts`, `Citizen Layout`, `Community 90`, `Community 123`, `Community 124`?**
  _High betweenness centrality (0.092) - this node is a cross-community bridge._
- **Why does `clsx` connect `Package Dependencies & Scripts` to `Community 86`?**
