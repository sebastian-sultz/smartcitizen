...
Cohesion: 0.07
Nodes (47): AdminCampaignsPage(), CareerSection(), OurStory(), priorities, campaignsColumns, CampaignsTable(), CitizenDashboard(), ContributionHistory() (+39 more)

### Community 3 - "Admin Dashboard & Tables"
Cohesion: 0.07
Nodes (39): LegalDocGrid(), PolicySection(), documents, LegalViewer(), MissionVision(), MissionVisionCard(), MissionVisionCardProps, cn() (+31 more)
...
Cohesion: 0.21
Nodes (9): Facebook(), Footer(), Instagram(), Twitter(), Youtube(), aboutLinks, activityLinks, Header() (+1 more)
...
Cohesion: 0.43
Nodes (4): ContentGrid(), ContentGridProps, ContentItem, EventRegisterButton()
...
Cohesion: 0.07
Nodes (51): AwarenessFeature(), AwarenessPage(), metadata, CitizenLayout(), AwarenessForm(), AwarenessFormProps, validationSchema, AwarenessList() (+43 more)
