        ...
        <div className="flex-1 space-y-8">
          <div className="space-y-4">
            ...
            <h2 className="font-display text-4xl md:text-5xl font-bold text-text">
              About GlobalSmart Citizens Foundation
            </h2>
          </div>
          <div className="space-y-6 text-text-muted text-[17px] leading-relaxed">
            <p>
              We are a people-centric, non-profit organization committed to
              building an aware, informed, and responsible society. Our
              Foundation works at the grassroots level to empower individuals,
              families, and communities.
            </p>
            <p>
              Our initiatives focus on environmental responsibility, health &
              wellness, digital and cyber safety, legal and constitutional
              awareness, child protection, education, financial literacy, civic
              sense, and social ethics.
            </p>
          </div>
        </div>
    ...
    <div className="max-content">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        {priorities.map((item, i) => (
          <div
            key={i}
            className="bg-white p-8 rounded-xl shadow-card border-b-4 border-primary/20 hover:border-primary transition-all group text-center"
          >
    ...
    <div className="max-content">
      <div className="bg-primary rounded-[32px] p-8 md:p-16 text-white overflow-hidden relative">
        <div className="relative z-10">
          <h2 className="font-display text-4xl md:text-5xl font-bold mb-12 text-center lg:text-left">
            Career With Us
          </h2>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24">
            <div className="space-y-6">
              <h4 className="text-xl font-bold text-accent-light border-b border-white/10 pb-4">
                We Welcome:
              </h4>
              <ul className="space-y-4 text-white/80">
                {[
                  ...
                  "Legal, digital, and health professionals",
                ].map((item, i) => (
          ...
          <div className="mt-16 text-center">
            <Link
              href="/join_us"
              className="inline-block bg-accent hover:bg-accent-light text-white px-10 py-4 rounded-xl font-bold transition-all shadow-xl shadow-accent/20"
            >
