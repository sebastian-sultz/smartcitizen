    ...
    <div className="mt-16 grid grid-cols-1 md:grid-cols-2 gap-8">
      <div className="bg-bg rounded-[32px] overflow-hidden border border-border shadow-lg group">
        <div className="aspect-video relative overflow-hidden">
          <Image src="/assets/s1.jpeg" alt="Volunteer Recognition" fill className="object-cover group-hover:scale-105 transition-transform duration-500" sizes="(max-width: 768px) 100vw, 50vw" priority />
      ...
      <div className="bg-bg rounded-[32px] overflow-hidden border border-border shadow-lg group">
        <div className="aspect-video relative overflow-hidden">
          <Image src="/assets/q8.jpeg" alt="Community Sports" fill className="object-cover group-hover:scale-105 transition-transform duration-500" sizes="(max-width: 768px) 100vw, 50vw" />
